...
def generate_plots_case0(time_points, pdu_counts, upf_counts, active_pdu_counts, active_upf_counts):
    ...
    plt.ylabel('PDU Count for case 0')
    ...
    plt.xlabel('Simulation Time')
    plt.ylabel('UPF Count for case 0')
    ...
    plt.xlabel('Simulation Time')
    plt.ylabel('Active PDU Count for case 0')
    ...
    plt.xlabel('Simulation Time')
    plt.ylabel('Active UPF Count for case 0')
...
def generate_plots_case1(time_points, pdu_counts, upf_counts, active_pdu_counts, active_upf_counts):
    ...
    plt.plot(time_points, pdu_counts, label='PDU Count', color='blue')
    plt.xlabel('Simulation Time')
    plt.ylabel('PDU Count for case 1')
    plt.title('PDU vs Simulation Time')
    plt.grid(True)
    plt.legend()
    ...
    plt.plot(time_points, upf_counts, label='UPF Count', color='green')
    plt.xlabel('Simulation Time')
    plt.ylabel('UPF Count for case 1')
    plt.title('UPF vs Simulation Time')
    plt.grid(True)
    plt.legend()
    ...
    plt.plot(time_points, active_pdu_counts, label='Active PDUs', color='red')
    plt.xlabel('Simulation Time')
    plt.ylabel('Active PDU Count for case 1')
    plt.title('Active PDUs vs Simulation Time')
    plt.grid(True)
    plt.legend()
    ...
    plt.plot(time_points, active_upf_counts, label='Active UPFs', color='orange')
    plt.xlabel('Simulation Time')
    plt.ylabel('Active UPF Count for case 1')
    plt.title('Active UPFs vs Simulation Time')
    plt.grid(True)
    plt.legend()
