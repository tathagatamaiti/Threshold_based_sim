...
if __name__ == "__main__":
    ...
    parser.add_argument("--arrival_rate", type=float, default=500, help="Inter-arrival rate in seconds (λ)")
    parser.add_argument("--mu", type=float, default=10, help="parameter for session duration in seconds (µ)")
